        ...
        <div class="cd-tab-filter-wrapper">
            <div class="cd-tab-filter">
                <ul class="cd-filters">
                    ...
                    <li class="filter"><a class="selected" href="{{ route('home') }}" data-type="all">Movies</a></li>
                    <li class="filter"><a href="{{ route('series.index') }}" data-type="color-1">Series</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('home') }}" method="GET">
                ...
                <select style="margin-bottom:20px; margin-left:10px" name="language">
                    ...
                    @foreach($languages as $language)
                        <option value="{{ $language->LANGUAGE_MOBIE }}" {{ request('language') == $language->LANGUAGE_MOBIE ? 'selected' : '' }}>
                            {{ $language->LANGUAGE_MOBIE }}
                        </option>
                    @endforeach
                </select>
                                ...
                                <figure class="figure tc-cardhover-14">
                                    <figcaption>
                                        <a href="{{ route('movie.show', $movie->ID) }}" rel="stylesheet" type="text/css">
                                            ...
                                            <p style="color: white !important; font-size: 12px;">{{ Str::limit($movie->DESCRIPTION_OF_MOVIE, 100) }}</p>
                                        </a>
                                    </figcaption>
                                    <img class="figure-img" src="{{ $movie->POSTER ?? asset('assets/img/91SCNVEssVL._AC_SY741_.jpg') }}" alt="{{ $movie->NAME_MOVIE }}">
                                </figure>
                            </div>
                        @endforeach
                    </div>
