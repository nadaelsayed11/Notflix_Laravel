...
<head>
    ...
    <title>Add Director - NOTflix Admin</title>
            ...
            <form method="POST" action="{{ route('admin.director.store') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="url" class="form-control" id="image" name="image" value="{{ old('image') }}" placeholder="https://example.com/director-photo.jpg">
                    </div>
                </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-12 text-center">
                        <button type="submit" class="btn btn-primary btn-lg" style="background: #219bd7;border: none;padding: 10px 40px;font-size: 18px;">
                            <i class="fa fa-save"></i> Add Director
                        </button>
