...
<head>
    ...
    <title>Add Series - NOTflix Admin</title>
    ...
    <div class="container">
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('admin.series.store') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="title" class="form-label">Series Title *</label>
                    ...
                    <div class="col-md-2">
                        <label for="duration" class="form-label">Episode Duration (min) *</label>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" class="form-control" id="episodes" name="episodes" value="{{ old('episodes') }}" min="1" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <button type="submit" class="btn btn-primary btn-lg" style="background: #219bd7;border: none;padding: 10px 40px;font-size: 18px;">
                            <i class="fa fa-save"></i> Add Series
                        </button>
