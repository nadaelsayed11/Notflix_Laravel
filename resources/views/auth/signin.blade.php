            ...
            <div class="row d-flex">
                ...
                <div class="col-md-6">
                    <div>
                        ...
                        <div>
                            <h1 style="color: rgb(255,255,255);text-align: center;margin-bottom: 24px;">Sign In</h1>
                        </div>
                        ...
                        <form action="{{ route('signin') }}" method="POST">
                            ...
                            <div style="text-align: center;">
                                <button class="btn btn-primary d-table-row" type="submit" style="width: 120px;border-radius: 45px;background: linear-gradient(28deg, #BD11FA, #46C2FF);border-width: 0px;box-shadow: -1px 1px 20px 8px var(--purple);margin-top: 18px;">Sign In</button>
                            </div>
                            <div style="margin-top: 22px;text-align: center;">
                                <p class="d-inline" style="color: rgb(255,255,255);">New Member?</p>
                                <a class="d-inline" style="color: rgb(72,203,255);text-shadow: 0px 0px 9px;font-weight: bold;font-style: italic;border-style: none;border-bottom-style: solid;" href="{{ route('signup') }}">Create An Account Here</a>
                            </div>
                        </form>
                    </div>
                </div>
